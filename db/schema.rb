...
ActiveRecord::Schema[7.0].define(version: 2023_10_03_074710) do
  create_table "event_comments", force: :cascade do |t|
    t.string "body", null: false
    t.integer "author_id", null: false
    t.integer "event_id", null: false
    t.datetime "created_at", null: false
    t.index ["author_id"], name: "index_event_comments_on_author_id"
  ...
  add_foreign_key "event_comments", "users", column: "author_id"
